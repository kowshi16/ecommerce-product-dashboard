...
const ProductCard: React.FC<ProductCardProps> = React.memo(({ product, onEdit, onDelete }) => {
    ...
    const placeholderImage = "https://images.unsplash.com/photo-1649972904349-6e44c42644a7?w=400&h=300&fit=crop";
        ...
        >
            ...
            <div className="relative h-56 overflow-hidden">
                ...
                <div className="absolute top-4 right-4">
                    <div className={`bg-gradient-to-r ${stockStatus.color} text-white px-3 py-1 rounded-full text-xs font-semibold shadow-lg`}>
                        {stockStatus.label}
                    </div>
                </div>
                ...
                <div className="absolute top-4 left-4">
                    <div className={`bg-gradient-to-r ${getCategoryGradient(product.category)} text-white px-3 py-1 rounded-full text-xs font-semibold shadow-lg`}>
                        {product.category}
                    </div>
                </div>
